...
"""
            ...
            page.title_template_block_1= content_text
            page.content_template_block_1 = content_text
            # Очищаем остальные блоки (если они были заполнены)
            page.title_template_block_2= ''
            page.content_template_block_2 = ''
            page.title_template_block_3= ''
            page.content_template_block_3 = ''
            page.title_template_block_4= ''
            page.content_template_block_4 = ''
