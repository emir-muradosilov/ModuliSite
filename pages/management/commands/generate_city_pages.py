    ...
    def handle(self, *args, **kwargs):
        ...
        for city in cities:
            ...
            for template in child_templates:
                ...
                if not parent_page:
                    # Если родительская страница не найдена, пробуем создать её рекурсивно
                    # (для случая, если родительский шаблон тоже не был создан)
                    parent_page = self.create_page(city, template.parent)
                    if not parent_page:
                        continue
...
#        )
        ...
        page = ServicePage.objects.create(
            ...
            title_template_block_1 = template.title_template_block_1,
            content_template_block_1 = template.content_template_block_1,
            img_template_block_1 = template.img_template_block_1,
            img_template_alt_block_1 = template.img_template_alt_block_1,
            title_template_block_2 = template.title_template_block_2,
            content_template_block_2 = template.content_template_block_2,
            img_template_block_2 = template.img_template_block_2,
            img_template_alt_block_2 = template.img_template_alt_block_2,
            title_template_block_3 = template.title_template_block_3,
            content_template_block_3 = template.content_template_block_3,
            img_template_block_3 = template.img_template_block_3,
            img_template_alt_block_3 = template.img_template_alt_block_3,
            title_template_block_4 = template.title_template_block_4,
            content_template_block_4 = template.content_template_block_4,
            img_template_block_4 = template.img_template_block_4,
            img_template_alt_block_4 = template.img_template_alt_block_4,
