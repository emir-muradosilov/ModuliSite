...
# block 1
    title_template_block_1 = models.CharField( max_length=255, null=True)
    content_template_block_1 = models.TextField( null=True,)
    img_template_block_1 = models.ImageField(upload_to='portfolio/',blank=True,null=True)
    img_template_alt_block_1 = models.CharField(max_length=255, null=True)
# block 2
    title_template_block_2 = models.CharField( max_length=255, null=True)
    content_template_block_2 = models.TextField( null=True,)
    img_template_block_2 = models.ImageField(upload_to='portfolio/',blank=True,null=True)
    img_template_alt_block_2 = models.CharField(max_length=255, null=True,)
# block 3
    title_template_block_3 = models.CharField( max_length=255, null=True)
    content_template_block_3 = models.TextField( null=True,)
    img_template_block_3 = models.ImageField(upload_to='portfolio/',blank=True,null=True)
    img_template_alt_block_3 = models.CharField(max_length=255, null=True,)
# block 4
    title_template_block_4 = models.CharField( max_length=255, null=True)
    content_template_block_4 = models.TextField( null=True,)
    img_template_block_4 = models.ImageField(upload_to='portfolio/',blank=True,null=True)
    img_template_alt_block_4 = models.CharField(max_length=255, null=True,)
